// 매장 : /showroom/store.html
function showroom3() {
    // 초기 진입시 메인 실행
    const sr3Store = $('.sr3-store');
    const srSw = sr3Store.find('.showroom-screen-wrap');
    const srSwArr = [
        sr3Store.find('.showroom-screen-wrap0'),
        sr3Store.find('.showroom-screen-wrap1'),
        sr3Store.find('.showroom-screen-wrap2'),
        sr3Store.find('.showroom-screen-wrap3'),
    ];
    const srPointer = sr3Store.find('.sr-pointer');
    ...
    startTimers.push(
        setTimeout(() => {
            sr3Store.removeClass('default').addClass('main');
    ...
    srPointer.on('click', function () {
        ...
        sr3Store.removeClass('main');
        sr3Store.addClass(screenClass + ' step1 step1-1');

        if (typeof showroomData !== 'undefined') {
            setPageContent('sr3-store', screenClass, showroomData);
    ...
    const popChkCompleteLink = sr3Store.find('.popup-check-complete-wrap');
    ...
    const btnScreen1End1 = sr3Store.find('.button-swiper-bottom-screen1');
    ...
    const btnScreen1End2 = sr3Store.find('.button-swiper-bottom-screen2');
    ...
    const btnScreen1End3 = sr3Store.find('.button-swiper-bottom-screen3');
    ...
    btnScreenWrap.on('click', function () {
        localStorage.setItem('previousPage', 'store.html'); // 이전페에지 가기 스토리지 저장
