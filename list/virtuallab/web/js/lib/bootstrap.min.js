...
!(function (t, e) {
    ...
    e(document)
        ...
        e(window).on('load.bs.button.data-api', function () {
            ...
            for (
                var s = 0, r = (t = [].slice.call(document.querySelectorAll('[data-toggle="button"]'))).length;
                s < r;
                s++
            ) {
                var a = t[s];
                ...
                (i._getOffset = function () {
                    ...
                    return (
                        'function' == typeof this._config.offset
                            ? (e.fn = function (e) {
                                  return (
                                      (e.offsets = a(a({}, e.offsets), t._config.offset(e.offsets, t._element) || {})),
                                      e
                                  );
                              })
            ...
            return (
                ...
                (i.setElementContent = function (t, n) {
                    'object' != typeof n || (!n.nodeType && !n.jquery)
                        ? this.config.html
                            ? (this.config.sanitize && (n = H(n, this.config.whiteList, this.config.sanitizeFn)),
                              t.html(n))
                            : t.text(n)
                        : this.config.html
                ...
                (i._getOffset = function () {
                    ...
                    return (
                        'function' == typeof this.config.offset
                            ? (e.fn = function (e) {
                                  return (
                                      (e.offsets = a(a({}, e.offsets), t.config.offset(e.offsets, t.element) || {})), e
                                  );
                              })
                ...
                (i._getConfig = function (t) {
                    ...
                    return (
                        ...
                        'number' ==
                            typeof (t = a(a(a({}, this.constructor.Default), n), 'object' == typeof t && t ? t : {}))
