                ...
                var n = (k.reel = {
                                        ...
                                        .each(function () {
                                            var h = k(this),
                                                ...
                                                I = {
                                                    setup: function () {
                                                        if (!(h.hasClass(z) && h.parent().hasClass(Bb))) {
                                                            ...
                                                            var Cb = e(D, +h.attr(D) || h.width()),
                                                                ...
                                                                gc = e(
                                                                    O,
                                                                    (v && ca) || (ba <= 1 && p.length) || g.frames,
                                                                ),
                                                                Hc = ba > 1 || v;
                                                            e(Ka, ac('x', E) || m / 2 || Cb * 2);
                                                            e(
                                                                Eb,
                                                                !Hc ? 0 : ac('y', E) || (ba > 3 ? Db : Db / (5 - ba)),
                                                            );
                                                            ba = m ? 1 : la(gc / ca);
                                                            e(Fb, m - (u ? 0 : Cb));
                                                            e($a, 0);
                                                            ...
                                                            l &&
                                                                k.each(Ic, function (cd, oc) {
                                                                    q[oc] = a(oc);
                                                                });
                                                            C(na + A + x(z), { display: Ob });
                                                            C(
                                                                x(Hb),
                                                                { position: 'fixed', left: y(-100), top: y(-100) },
                                                                true,
                                                            );
                                                            C(
                                                                x(Hb) + A + Xa,
                                                                { position: Qa, width: 10, height: 10 },
                                                                true,
                                                            );
                                                            ha.bind(I.pool);
                                                    ...
                                                    instance: {
                                                        ...
                                                        setup: function () {
                                                            ...
                                                            h.unbind(jb, ia);
                                                            i.bind(Mc, c)
                                                                .bind(g.clickfree ? Nc : Oc, c)
                                                                .bind(g.wheelable ? Pc : null, d)
                                                                .bind(Qc, function () {
                                                                    return false;
                                                                });
                                                            C(P, { cursor: Va(l) });
                                                            ...
                                                            g.monitor &&
                                                                b.append((sc = k(V(ta), { class: tc }))) &&
                                                                C(A + x(tc), { position: Qa, left: 0, top: 0 });
                                                        },
                                                        preload: function () {
                                                            function c() {
                                                            ...
                                                            for (h.trigger('resize', true); b.length; ) {
                                                                ...
                                                                k(V(Xa))
                                                                    .data(ra, p)
                                                                    .appendTo(l)
                                                                    .bind('load error abort', function (q) {
                                                        ...
                                                        down: function (c, d, b, i) {
                                                            ...
                                                            if (
                                                                !(!g.clickfree && i && i.button !== s && i.button != Sc)
                                                            )
                                                                if (g.draggable) {
                                                                    e(ea, a(J));
                                                                    c = g.clickfree;
                                                        ...
                                                        orient: function (c, d) {
                                                            if (!(!Ua || R)) {
                                                                ...
                                                                fraction = e(
                                                                    B,
                                                                    +(g.stitched || g.cw ? 1 - c : c).toFixed(2),
                                                                );
                                                                Ua = false;
                                                            }
                                                        },
                                                            ...
                                                            if (d === s) {
                                                                ...
                                                                if (!c.length || v) {
                                                                    ...
                                                                    if (v) {
                                                                        ...
                                                                        c &&
                                                                            h.css('backgroundImage').search(d) < 0 &&
                                                                            h.css({ backgroundImage: Ea(d) });
                                                                    } else {
                                                                        i = g.horizontal;
                                                                        l = (b % u) - 1;
                                                                        l = l < 0 ? u - 1 : l;
                                                        ...
                                                        'up.annotations': function (c, d) {
                                                            if (!(G > 10 || qb)) {
                                                                c = k(d.target);
                                                                (c.is('a') ? c : c.parents('a')).attr('href') &&
                                                                    (G = 10);
                                                            }
                                                        },
                                                ...
                                                Ra = function (c) {
                                                    ...
                                                    return (Ra['$' + c] = k(V(ta), { class: zc + A + c }));
                                                },
                                                C = function (c, d, b) {
                                                    function i(p) {
                                                        var m = [];
                                                ...
                                                Xb = function (c, d, b, i) {
                                                    if (i) {
                                                        ...
                                                        b = c != B ? b : Ga(b, 0.9999);
                                                        return (d =
                                                            +H(p - b).toFixed(8) >= +(1 / (i - 1)).toFixed(8)
                                                                ? e(c, b)
                                                                : d || p);
                                                    }
                                                },
                        ...
                        substitute: function (f, j) {
                            return f.replace(n.re.substitution, function (o, t, r) {
                                return typeof n.substitutes[r] == 'function'
                                    ? n.substitutes[r](j)
                                    : Ac[r]
                                    ? j(Ac[r])
                                    : t;
