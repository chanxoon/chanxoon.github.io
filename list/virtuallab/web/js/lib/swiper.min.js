                                ...
                                if (!a.isTouchEvent || 'mousemove' !== n.type) {
                                    ...
                                    if (
                                        ...
                                        if (
                                            !(
                                                t.params.threshold &&
                                                Math.sqrt(Math.pow(d, 2) + Math.pow(p, 2)) < t.params.threshold
                                            )
                                        ) {
                                            var c;
        ...
        G = {
            ...
            init: function () {
                ...
                if (e.params.scrollbar.el) {
                    ...
                    0 === r.length &&
                        ((r = I('<div class="' + e.params.scrollbar.dragClass + '"></div>')), s.append(r)),
            ...
            setTranslate: function () {
                ...
                for (var h = 0; h < s.length; h += 1) {
                    ...
                    if (
                        ...
                        0 === E.length &&
                            ((E = I('<div class="swiper-slide-shadow-' + (p ? 'left' : 'top') + '"></div>')),
                            v.append(E)),
                            0 === S.length &&
                                ((S = I('<div class="swiper-slide-shadow-' + (p ? 'right' : 'bottom') + '"></div>')),
                                v.append(S)),
            ...
            setTranslate: function () {
                for (
                    ...
                    if ((v.transform(T), (v[0].style.zIndex = 1 - Math.abs(Math.round(m))), n.slideShadows)) {
                        ...
                        0 === E.length &&
                            ((E = I('<div class="swiper-slide-shadow-' + (o ? 'left' : 'top') + '"></div>')),
                            v.append(E)),
                            0 === S.length &&
                                ((S = I('<div class="swiper-slide-shadow-' + (o ? 'right' : 'bottom') + '"></div>')),
                                v.append(S)),
            ...
            onThumbClick: function () {
                ...
                if (t) {
                    ...
                    if (!((i && I(i).hasClass(e.params.thumbs.slideThumbActiveClass)) || null == a)) {
                        var s;
                        if (
                            ((s = t.params.loop ? parseInt(I(t.clickedSlide).attr('data-swiper-slide-index'), 10) : a),
                            e.params.loop)
                        ) {
                            var r = e.activeIndex;
